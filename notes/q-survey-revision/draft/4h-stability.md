...
The *deadly triad* [@sutton_2018_book] names the combination of
...
The success of DQN [@mnih_2015_nature] and its descendants depends on a collection
...
**B.1. Target networks.** Nature DQN [@mnih_2015_nature] introduced the use of a
...
Architectures [@wang_2016_dueling] decompose $Q$ into a state-value baseline $V(s)$
...
The original motivation [@wang_2016_dueling] was to improve learning
...
gradient interactions. The Rainbow ablation [@hessel_2018_rainbow] supports this
...
**B.3. Normalization and weight decay.** Layer normalization [@ba_2016_layernorm] in
...
emerged since 2020. Parameterized Q-Network (PQN) [@gallici_2024_pqn] is the
...
PQN matches or exceeds PER [@schaul_2016_per], Double DQN [@hasselt_2016_doubledqn], and Rainbow [@hessel_2018_rainbow]
...
**B.4. Consolidation losses.** MeDQN [@chen_2023_medqn] (also discussed in §IV.B
...
[@kirkpatrick_2017_ewc] in the continual-learning literature; the
...
**Ablation-based evidence.** Rainbow's ablation [@hessel_2018_rainbow] places
...
**PQN's direct test.** PQN [@gallici_2024_pqn] is the strongest existing empirical
